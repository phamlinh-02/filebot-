module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "Dũngkon",
    description: "Đánh giá độ đẹp gái",
    commandCategory: "Tiện ích",
    usages: "dodepgai [reply/@tag]",
    cooldowns: 5
};
...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  if (Object.keys(event.mentions).length == 1) {
    ...
    const callback = () => api.sendMessage({
      body: `🌸 ĐỘ ĐẸP GÁI 🌸\n\n👤 Tên: ${name}\n💯 Độ xinh gái: ${percent}%`,
      attachment: fs.createReadStream(__dirname + "/cache/dodepgai.png")
    }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/dodepgai.png"), event.messageID);
    ...
    return request(encodeURI(`https://graph.facebook.com/${mentions}/picture?height=1500&width=1500&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`))
      .pipe(fs.createWriteStream(__dirname + '/cache/dodepgai.png'))
      .on('close', () => callback());
  } 
  else {
    let idmen;
